...
if status.result.total_count ~= 0 then
	sendPhotoById(msg.to.id, status.result.photos[1][1].file_id, msg.id, '💢¦ اسمك : '..nameuserx..'\n💢¦ معرفك : '..userxn..'\n💢¦ ايديك : '..msg.from.id..'\n💢¦ رتبتك : '..rank..'\n💬¦ عدد رسائلك : ['..msgs..'] رسالة 💯\n')
	else
...
rules = data[tostring(msg.to.id)]['rules']
     ...
     rules = "💢¦ _مرحبأ عزيري_ 👋🏻 _القوانين كلاتي_ 👇🏻\n💢¦ _ممنوع نشر الروابط_ \n💢¦ _ممنوع التكلم او نشر صور اباحيه_ \n💢¦ _ممنوع  اعاده توجيه_ \n💢¦ _ممنوع التكلم بلطائفه_ \n💢¦ _الرجاء احترام المدراء والادمنيه _😅\n💢¦ _تابع _"..check_markdown("@CHTH3CZAR")
end
...
user_name = ""
 ...
 if msg.newuser.id == bot.id then
   local rsala = [[💢¦ مٌرَحُبّاً انَا بّوَتْ اسِمٌيَ TH3CZAR 🎖
💢¦ اٌختْصّاصّيَ حُمٌايَةِ كِرَوَبّاتْ
💢¦¦مٌنَ الُسِبّامٌ وَالُوَسِائطِ وَالُتْكِرَارَ وَالٌُخ...
💢¦ مطور البوت : @TH3CZAR]]
	sendPhoto(msg.to.id, "data/photos/TH3CZAR.jpg", rsala, msg.id)
end
end
end
return {
