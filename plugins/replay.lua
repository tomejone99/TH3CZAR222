...
if (msg.to.type == "private") and not is_sudo(msg) and msg.from.id ~= our_id and w~="/start"  then

fwd_msg(msg.from.id, sudo_id, msg.id)
if w and msg.reply_to_message and msg.reply.fwd_from and is_sudo(msg) then
send_msg(msg.reply.fwd_from,w)
...
if string.match(ww, 'احمد')  or  string.match(ww, 'حمودي') or  string.match(ww, 'حماده') or  string.match(ww, 'حموشي')  or string.match(ww, 'حمود') then
return true
else
return false
end
...
----------------------------------------------
if is_sudo(msg) and w == "قيصر" and not ww then 
return  su[math.random(#su)]  
elseif not is_sudo(msg) and w == "قيصر" and not ww then 
...
elseif w == "قيصر رزله" and ww and is_sudo(msg) then
if msg.reply_id then
...
return "سحك وعدل 😹☝🏿"
-------------- صوتيات
elseif w == "قيصر عفط" and ww and msg.reply_id and is_sudo(msg) then
if msg.reply_id then
sendVoice(msg.to.id, 'data/zeg.ogg', msg.reply_id, '💢اسمع الزيج  اسمع 🔊')
end
elseif w == "قيصر اضحك" and ww and msg.reply_id and is_sudo(msg) then
if msg.reply_id then
